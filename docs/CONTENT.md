...
All text content for the portfolio in Norwegian (default) and English.
...
```json
{
  "bygger": {
    ...
    "github": {
      "title": "GitHub",
      "description": "Følg med på hva jeg bygger",
      "cta": "Se GitHub-profilen"
    }
  }
}
```
...
```json
{
  "bygger": {
    ...
    "github": {
      "title": "GitHub",
      "description": "Follow what I'm building",
...
```json
{
  "contact": {
    ...
    "description": "Åpen for nye muligheter og interessante prosjekter.",
    "email": {
      "label": "E-post",
      "value": "sebastian.rosnes.sorensen@hotmail.com"
    },
    "phone": {
      "label": "Telefon",
      "value": "+47 472 78 212"
...
```json
{
  "contact": {
    "title": "Contact",
    "subtitle": "Let's talk",
    "description": "Open to new opportunities and interesting projects.",
    "email": {
      "label": "Email",
      "value": "sebastian.rosnes.sorensen@hotmail.com"
    },
...
### i18n/messages/no.json

See the individual sections above compiled into a single JSON file.
